...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
    <div class="bg-white rounded-lg shadow-lg p-6">
        <div class="flex items-center">
            <div class="flex-1">
                <h3 class="text-gray-500 text-xs md:text-sm font-semibold uppercase">Total Services</h3>
                <p class="text-2xl md:text-3xl font-bold text-gray-800">{{ $stats['services'] }}</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        <div class="flex items-center">
            <div class="flex-1">
                <h3 class="text-gray-500 text-xs md:text-sm font-semibold uppercase">Gallery Images</h3>
                <p class="text-2xl md:text-3xl font-bold text-gray-800">{{ $stats['galleries'] }}</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        <div class="flex items-center">
            <div class="flex-1">
                <h3 class="text-gray-500 text-xs md:text-sm font-semibold uppercase">Contact Messages</h3>
                <p class="text-2xl md:text-3xl font-bold text-gray-800">{{ $stats['contacts'] }}</p>
            </div>
...
<div class="bg-white rounded-lg shadow-lg p-4 md:p-6">
    <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-4">Welcome to Admin Panel</h2>
    <p class="text-gray-600 mb-4 text-sm md:text-base">Manage your website content from this dashboard. Use the sidebar navigation to access different sections.</p>
